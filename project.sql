...
scategory_num NUMBER(7) REFERENCES scategory(scategory_num), -- 카테고리번호			
pname VARCHAR2(100), -- 상품명			
pdesc VARCHAR2(100), -- 상품설명			
price NUMBER(10), -- 가격			
