...
<div id="wrap">
    <div class="product-updateForm">
        ...
        <div class="cg-banner">
            <p>제품 수정</p>
            <p class="bn-desc">수정할 제품 정보를 입력하세요.</p>
        </div>
        
        <!-- 제품정보입력폼 -->
        <form action="${cp}/admin/product/updateok" method="post" enctype="multipart/form-data">
        <input type="hidden" name="pnum" value="${pnum }">
        <div class="cg-contents">
        
            <div class="img-container">
                <img id="ThumImg" style="" src="${cp }/upload/product/${thumImgFile }">
                <span class="fileName"><br>미첨부시 변경되지 않습니다.</span>
                <input type="file" id="thumImgFile" name="thumImgFile" style="display: none" value="${cp }/upload/product/${thumImgFile}"/>
            ...
            <div class="txt-container">
                <table>
                    <tr>
                        <th>카테고리</th>
                        <td><input type="text" id="bigCg" name="bigCg" placeholder="대분류 카테고리 입력" value="${bigCg }"></td>
                        <td><input type="text" id="smallCg" name="smallCg" placeholder="소분류 카테고리 입력" value="${smallCg }"></td>
                        <!-- 
                        <td>
                    ...
                    <tr>
                        <th>상품명</th>
                        <td colspan="2"><input type="text" id="prdName" name="prdName" value="${prdName }"></td>
                    </tr>
                    <tr>
                        <th>상품설명</th>
                        <td colspan="2"><input type="text" id="shotDesc" name="shotDesc" value="${shotDesc }"></td>
                    </tr>
                    <tr>
                        <th>가격</th>
                        <td colspan="2"><input type="text" id="price" name="price" value="${price }"> 원</td>
                    </tr>
                    <tr>
                        <th>할인율</th>
                        <td colspan="2"><input type="text" id="priceOff" name="priceOff" value="${priceOff }"> %</td>
                    </tr>
                    <tr>
                        <th>재고</th>
                        <td colspan="2"><input type="text" id="qty" name="qty" value="${qty }"> 개</td>
                    </tr>
                    <tr>
                        <th>상세이미지</th>
                        <!-- <td colspan="2"><input type="button" value="상세이미지 첨부" class="button buttonTemp descImg"><span class="fileName">파일명</span></td> -->
                        <td colspan="2"><input type="file" id="descImg" name="descImg"><span class="fileName"><br>미첨부시 변경되지 않습니다.</span></td>
                    </tr>
                </table>
                <input type="submit" value="수정 완료" class="button buttonTemp insertBtn">
            </div>
