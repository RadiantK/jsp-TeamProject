...
<jsp:include page="/WEB-INF/page/include/header.jsp" />
	...
	<div class="container">
		...
		<c:set var="m" value="${requestScope.vo }"/>
		
		<form action="${cp }/board/QNA/Update?qnaNum=${m.qnaNum}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label for="writer">작성자</label><br> <input type="text"
					...
					value="${m.nickname}" readonly="readonly">
			</div><br>

			<div class="form-group">
				<label for="content">내용</label><br>
				<textarea class="form-control" rows="10" id="content" name="content">${m.content }</textarea>
			</div><br>

			<div class="form-group">
				<label for="file">파일첨부</label><br> <input type="file"
					class="form-control" value="${m.image }" id="image" name="image">
			</div><br>
