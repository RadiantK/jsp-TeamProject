...
<body>
	...
	<main>
		<div class="container">
			<h1>공지사항(관리자용)</h1>
			<form action="${cp }/board/Notice/insert" method="post">
				...
				<div class="form-group">
					<label for="writer">작성자</label><br> <input type="text"
						class="form-control" id="nickname" name="nickname" value="admin"
						readonly="readonly">
				</div>
				<br>
				...
				<a href="${cp }/board/Notice/List" class="button btn--reverse"
