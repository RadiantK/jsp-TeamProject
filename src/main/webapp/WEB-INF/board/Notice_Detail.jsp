...
<main>
		<div class="container">
			<div class="row">
				...
				<div class="btn-group">
					<a href="${cp }/Notice_List" class="button btn--reverse">목록</a>&nbsp;&nbsp;
					<c:if test="${sessionId=='admin' }">
					<a href="${cp }/Notice_Update?noticeNum=${vo.noticeNum}" class="button btn--reverse">수정</a> &nbsp;&nbsp;
					<a onclick="return confirm('삭제하시겠습니까?')" href="" class="button btn--reverse">삭제</a>
					</c:if>
				</div>
			</div>
		</div>
